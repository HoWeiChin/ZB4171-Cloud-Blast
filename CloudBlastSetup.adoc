...
image::img11.1.PNG[width="790"]

`Step 4`: Stop the GCP instance

Remember to stop our GCP VM to prevent incurring additional cost. This can be down by selecting the "stop" button under the dropdown button beside the "Connect" button.
