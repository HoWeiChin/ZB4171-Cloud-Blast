...
If you are met with any problems, detailed instructions for creating a GCP account and lauching VM can be found [here](cloud.google.com/compute/docs/quickstart-linux).
